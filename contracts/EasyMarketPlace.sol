...
import "./SimpleERC721.sol";
 ...
 import "@openzeppelin/contracts/utils/cryptography/draft-EIP712.sol";
    ...
    contract EasyMarketPlace is AccessControl, IERC721Receiver, EIP712, PullPayment {
 ...
 /**
    ...
    function onERC721Received(
        ...
        return this.onERC721Received.selector; // return 0x150b7a02 первые 4 байта идентификатора интерфейса
    } 
            ...
            returns (bool)
        {
            ...
            for (uint256 i = 0; i < marketPlaceItems[address(this)].length; ) {
                if (_selectId == marketPlaceItems[address(this)][i]) {
        ...
        function setERC721Contract(address _newContract) external onlyRole(DEFAULT_ADMIN_ROLE){
            require(_newContract != address(0), "Invalid address");
            simpleERC721 = SimpleERC721(_newContract);
        } 
